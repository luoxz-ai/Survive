...
PC->Parameters.Add(TEXT("bImmediately"), new FBoolParamValue(true));
PC = &FC->Functions.Add(TEXT("PlayCameraShake"));
PC->Parameters.Add(TEXT("Scale"), new FFloatParamValue(1.000000f));
...
PC->Parameters.Add(TEXT("bImmediately"), new FBoolParamValue(true));
PC = &FC->Functions.Add(TEXT("ClientPlayCameraShake"));
PC->Parameters.Add(TEXT("Scale"), new FFloatParamValue(1.000000f));
...
FC = &GDefaultParamCollection.Add(TEXT("ANUTActor"));
PC = &FC->Functions.Add(TEXT("UnitTravel"));
PC->Parameters.Add(TEXT("Dest"), new FStringParamValue(TEXT(" ")));
PC = &FC->Functions.Add(TEXT("UnitSeamlessTravel"));
PC->Parameters.Add(TEXT("Dest"), new FStringParamValue(TEXT(" ")));
